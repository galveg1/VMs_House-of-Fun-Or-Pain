...
void main(void)
{
    ...
    BIOS_start();        // starts BIOS Scheduler


}//end main modifiedto use int to call toggle
...
void ledToggle(void)
{
    //Added code to toggle GPIO
    //GpioDataRegs.GPBTOGGLE.bit.GPIO34 = 1;



    /*Below code moved from main*/
    ...
    //added code
    Log_info1("TOGGLE LED [%u] times", i16ToggleCount);
